...
public class  PackageDependencyTests {
    ...
    @ArchTest
    ArchRule modulesPackageRule = classes().that().resideInAPackage("com.hanker.modules..")
            .should().onlyBeAccessed().byClassesThat()
            .resideInAnyPackage("com.hanker.modules..");
    ...
    @ArchTest
    ArchRule cycleCheck = slices().matching("com.hanker.modules.(*)..")
