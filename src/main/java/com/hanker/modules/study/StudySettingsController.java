package com.hanker.modules.study;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.hanker.modules.account.CurrentUser;
...
import com.hanker.modules.study.form.StudyDescriptionForm;
import com.hanker.modules.tag.TagRepository;
import com.hanker.modules.tag.TagService;
...
public class StudySettingsController {
    ...
    @GetMapping("/tags")
    public String studyTagsForm(@CurrentUser Account account, @PathVariable String path, Model model) throws
